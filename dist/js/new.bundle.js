...
/***/ function(module, exports, require) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/* WEBPACK VAR INJECTION */(function(require, $) {!(__WEBPACK_AMD_DEFINE_ARRAY__ = [require(2), require(3), require(1), require(4), require(10), require(9), require(12), require(13), require(5)], __WEBPACK_AMD_DEFINE_RESULT__ = (function(header, api, common, URLParser) {
	    var p = {
	        timer: {},
	        direction: 1,
	        timeout: 3000
...
/***/ function(module, exports, require) {
	...
	!/* require */(/* empty */function() { /* WEBPACK VAR INJECTION */(function(require, $) {var __WEBPACK_AMD_REQUIRE_ARRAY__ = [require(3), require(1), require(7)]; (function (api, common) {
	    //实现搜索输入框的输入提示js类
	    var lastKeyWords,
	        matchListCache = {},
	        hotDatas = [];
	...
	/* WEBPACK VAR INJECTION */}.call(this, require, require(6)))}());
