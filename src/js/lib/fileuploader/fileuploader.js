 ...
 */
define(["avalon", 
    "text!"+ _WEB_Cfg.domain +"/fileuploader.html", 
    "browser", 
    _WEB_Cfg.jsLibPath + "fileuploader/eventmixin.min.js",
    _WEB_Cfg.jsLibPath + "fileuploader/blob.min.js",
    _WEB_Cfg.jsLibPath + "fileuploader/file.min.js",
    _WEB_Cfg.jsLibPath + "fileuploader/flasheventhub.min.js",
    _WEB_Cfg.jsLibPath + "fileuploader/runtime.min.js",
    _WEB_Cfg.jsLibPath + "fileuploader/blobqueue.min.js",
    _WEB_Cfg.jsLibPath + "fileuploader/spark-md5.min.js",
    _WEB_Cfg.jsLibPath + "fileuploader/inputproxy.min.js",
    "mmRequest",
    "css!"+ _WEB_Cfg.staticPath + "css/uploader.css"],
        ...
        var widget = avalon.ui[widgetName] = function(element, data, vmodels) {
            ...
            var vmodel = avalon.define(data[widgetName+'Id'], function(vm) {
                ...
                vm.$fileInputProxy.addEventListener("newFileSelected", function(fileInfo) {
                    ...
                    vm.uploadFile(vm, newPreviews.fileLocalToken);
                }, vm);
            ...
            getFileMessageText: function (fileObj) {
                ...
                switch (fileObj.status) {
                    ...
                    case fileObj.FILE_IN_UPLOADING:
                        message = "上传中{0}%".replace('{0}', fileObj.uploadedPercentage);
                        break;
