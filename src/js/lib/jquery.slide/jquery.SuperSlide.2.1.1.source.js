(function($) {
	$.fn.slide = function(options) {
		...
		return this.each(function() {
			...
			var vda = (opts.vda == "false" || opts.vda == false) ? false : true;
			...
			var doEndFun = function() {
				...
				if(vda){
					var $signle = conBox.children().not(".clone").eq(index).find("a.j-vda");
					$signle.hasClass("ishide") && cuvvic.sendShow("", $signle)
				}
			}
