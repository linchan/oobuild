...
//        }
      ...
      zoom: function(percent) {
        ...
        console.info("minPercent:"+this.minPercent);
        console.info("percent:"+this.percent);
        this.img_width = Math.ceil(this.width * this.percent);
        this.img_height = Math.ceil(this.height * this.percent);
      ...
      zoomIn: function() {
        this.zoom(this.percent + (0.6 - this.minPercent) / (this.options.zoom - 1 || 1));
//    	  this.zoom(this.percent);
      },
      zoomOut: function() {
        this.zoom(this.percent - (0.6 - this.minPercent) / (this.options.zoom - 1 || 1));
//    	  this.zoom(this.percent);
