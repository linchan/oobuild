...
<jsp:include page="common/header.jsp">
    ...
    <jsp:param name="title" value="${param.q}"/>
...
<div class="w">
    <div class="breadcrumb">
        <a href="/search.html" title="所有类目" vda="link|fliter">
            所有类目
        </a>
        <c:if test="${fn:length(param.q) > 0}">
            <span class="keyword-box">
                &nbsp;&gt;&nbsp;
                <span class="keyword">
                    <span class="text">${param.q}</span>
                    <a href="/search.html" class="vvicon" vda="link|fliter">&#xe60a;</a>
                </span>
            </span>
        </c:if>
    ...
    <div class="screen">
        ...
        <c:forEach items="${categorys}" var="cat">
            ...
            <div class="catid_${cat.pid} catid">
                <c:forEach items="${cat.list}" var="list" varStatus="status">

                    <c:set var="lastclassname" value=""/>
                    <c:if test="${status.last}">
                        <c:set var="lastclassname" value="last"/>
                    </c:if>
                    <div class="nav-category clearfix  ${lastclassname}">
        ...
        <div class="nav-category nav-filter clearfix">
        ...
        <div class="nav-category clearfix last j-guess-wrap" style="display: none;">
            <div class="nc-key">您是不是想要找</div>
            <div class="nc-value">

                <div class="types j-guess-list-box"></div>
            </div>
        </div>
    ...
    <div class="fl search-main">
        <div class="goods-sort">
            <div class="pro-sort">
                <div class="mini-page s-b-right"></div>

                <div class="s-b-left clearfix">
                    <ul>
                        <a href="#/sort/default" class="h-item  sort-default">
                            <span>综合</span>
                        </a>
...
<script type="text/x-handlebars-template" id="cardTemplate">
    {{ _.each(list, function(item, index){ }}
        ...
        <li>
            ...
            <div class="item">
                <div class="pic">
                    <a target="_blank" href="/item/{{=item.item_id}}" class="j-vda" vda="tp|{{=blockName}}|{{=item.item_id}}|0|0|{{=index+1}}">
